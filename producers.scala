...
/**
  * Class that represents Producer entity
  *
  * @tparam T
  */
...
/**
  * Class that represents Producers entity
  */
object Producers extends Application {
  ...
  /**
    * Class that represents PreOrder entity
    *
    * @param n
    */
  ...
  /**
    * Class that represents PostOrder entity
    *
    * @param n
    */
  ...
  /**
    * Class that represents InOrder entity
    *
    * @param n
    */
